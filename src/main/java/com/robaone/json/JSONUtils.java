...
public class JSONUtils {
	...
	public static org.json.JSONObject merge(org.json.JSONObject old_jo,
			org.json.JSONObject new_jo) throws JSONException {
	...
	public static void createXMLDocumentElement(Document doc, Node parent,
